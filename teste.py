...
# ===== AJUSTES =====
COM_PORT = "COM11"          # troque para sua porta (ex.: "COM7", "/dev/ttyACM0")
BAUD     = 115200
...
RIGHT_CLICK_SET = {"cap_carlin.png","norf.png","kawill.png","pydar.png","upboatthais.png","upc1.png","upc2.png","upab1.png","upab2.png","upab3.png","upab4.png","upab5.png","upboatab.png","eremo.png","wag1.png","wag2.png"}
...
def move_click_flag(ser, img_path, wait_after_click_s):
    ...
    Move o mouse para o centro da tela após clicar em flag1-5.png.
    """
    ...
    # Move mouse para o centro se for uma das flags
    if base in {"flag1.png", "flag2.png", "flag3.png", "flag4.png", "flag5.png"}:
        wait_exact(0.2, show_result=False)  # pequena pausa antes de mover
        move_mouse_to_center(ser)
...
def move_mouse_to_center(ser):
    """Move o mouse para o centro da tela usando o Arduino."""
    ...
    print(f"Movendo mouse para o centro da tela ({center_x},{center_y}) via Arduino...")
    
    # Envia comando de movimento relativo para o Arduino
    if not send_line(ser, f"R {dx} {dy}"):
        print("Falha ao enviar comando de centralização.")
        return False
    
    wait_exact(0.1, show_result=False)
    return True
...
def type_sequence6(ser):
    # ENTER -> 'hi' -> ENTER -> 'carlin' -> ENTER -> ENTER -> 'yes'
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT hi");     wait_exact(2.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT cormaya"); wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KT yes");    wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)

def type_sequence7(ser):
    # ENTER -> 'hi' -> ENTER -> 'carlin' -> ENTER -> ENTER -> 'yes'
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT hi");     wait_exact(2.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT eremo"); wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KT yes");    wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)

def type_sequence8(ser):
    # ENTER -> 'hi' -> ENTER -> 'carlin' -> ENTER -> ENTER -> 'yes'
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT hi");     wait_exact(2.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT wisdom"); wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KT yes");    wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
...
def type_sequence9(ser):
    # ENTER -> 'hi' -> ENTER -> 'carlin' -> ENTER -> ENTER -> 'yes'
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT hi");     wait_exact(2.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT kazordoon"); wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KT yes");    wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)    

def type_sequence10(ser):
    # ENTER -> 'hi' -> ENTER -> 'carlin' -> ENTER -> ENTER -> 'yes'
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT hi");     wait_exact(2.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(1.00, show_result=False)
    send_line(ser, "KT spark"); wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
    send_line(ser, "KT yes");    wait_exact(1.00, show_result=False)
    send_line(ser, "KE ENTER");  wait_exact(0.50, show_result=False)
...
def main():
    ...
    try:
        with serial.Serial(COM_PORT, BAUD, timeout=1) as ser:
            ...
            # ---- ida thais ----
            if not move_click_flag(ser, "flag1.png", 50,):   return
            if not move_click_flag(ser, "flag2.png", 72):  return
            if not move_click_flag(ser, "sqm1.png", 5):    return

            # ALT+clique + sequência (flag6)
            if not move_click_flag(ser, "norf.png", 3):  return
            if not move_click_flag(ser, "follow.png", 3):  return
            type_sequence(ser)  # <-- só segue após ESC ter sido enviado
            # ---- volta ----
            if not move_click_flag(ser, "flag3.png", 7): return
            if not move_click_flag(ser, "flag1.png", 72):  return

            # ida pro dp/barco
            if not move_click_flag(ser, "flag5.png", 32):  return
            if not move_click_flag(ser, "flag4.png", 12):  return
            ...
            # ida carlin
            if not move_click_flag(ser, "flag1.png", 8):  return
            if not move_click_flag(ser, "flag2.png", 45):   return
            if not move_click_flag(ser, "flag3.png", 39):   return
            ...
            #volta barco carlin
            if not move_click_flag(ser, "flag5.png", 5):  return
            if not move_click_flag(ser, "flag2.png", 34):   return
            if not move_click_flag(ser, "flag1.png", 42):   return
            if not move_click_flag(ser, "upc2.png", 5):   return  # right-click automático
            if not move_click_flag(ser, "flag3.png", 8):  return
            if not move_click_flag(ser, "cap_carlin.png", 2):  return
            if not move_click_flag(ser, "follow.png", 5):  return
            ...
            if not move_click_flag(ser, "eremo.png", 5):   return  # right-click automático
            if not move_click_flag(ser, "follow.png", 5):  return
            type_sequence8(ser)
            
            #ida para kazordoom
            if not move_click_flag(ser, "flag1.png", 5):  return
            if not move_click_flag(ser, "flag2.png", 46):  return
            if not move_click_flag(ser, "flag3.png", 3):   return  # 
            if not move_click_flag(ser, "flag3.png", 3):   return  # 
            if not move_click_flag(ser, "flag3.png", 3):   return  # - 
            if not move_click_flag(ser, "flag3.png", 3):   return  # - 
            if not move_click_flag(ser, "flag3.png", 3):   return  # - 
            if not move_click_flag(ser, "flag3.png", 3):   return  # - 
            if not move_click_flag(ser, "flag3.png", 3):   return  # -     
            if not move_click_flag(ser, "flag4.png", 3):   return  # - 
            if not move_click_flag(ser, "flag4.png", 8):   return  #
            type_sequence9(ser)

            #bless kazordoon
            if not move_click_flag(ser, "flag1.png", 15):  return
            if not move_click_flag(ser, "wag1.png", 3):  return
            if not move_click_flag(ser, "flag2.png", 28):   return  # 
            if not move_click_flag(ser, "flag3.png", 19):   return
            if not move_click_flag(ser, "kawill.png", 3):   return
            if not move_click_flag(ser, "follow.png", 3):  return
            type_sequence10(ser)
            if not move_click_flag(ser, "flag4.png", 19):   return
            if not move_click_flag(ser, "flag5.png", 28):   return  # - 
            if not move_click_flag(ser, "flag1.png", 28):   return  # - 
            if not move_click_flag(ser, "pydar.png", 3):   return  # right-click automático
            if not move_click_flag(ser, "follow.png", 3):  return
            type_sequence10(ser)
            if not move_click_flag(ser, "flag4.png", 28):   return  # - 
            #if not move_click_flag(ser, "wag2.png", 3):   return  # 
            #if not move_click_flag(ser, "flag3.png", 3):   return  # - 
            #f not move_click_flag(ser, "flag3.png", 3):   return  # -     
            #if not move_click_flag(ser, "flag4.png", 3):   return  # - 
            #if not move_click_flag(ser, "flag4.png", 8):   return  #
